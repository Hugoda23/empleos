...
<body class="index-page">
  ...
  <header id="header" class="header sticky-top">
    ...
    <div class="topbar d-flex align-items-center">
      <div class="container d-flex justify-content-center justify-content-md-between">
        <div class="d-none d-md-flex align-items-center">
          <i class="bi bi-geo-alt-fill"></i> Santa Cruz del Quiché</div>
        <div class="d-flex align-items-center">
          <i class="bi bi-telephone"></i> 7755-0000
        </div>
      </div>
    </div><!-- End Top Bar -->
    ...
    <a href="{{url('/public')}}" class="logo d-flex align-items-center me-auto">
        <img src="assets/img/gallery/marca-clinica-cardiologia.png" alt="" class="img-fluid logo-img"> 
        <h1 class="sitename">Clinica HCJMS</h1> 
    </a>
</div>
      ...
      <div id="hero-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
        ...
        <div class="carousel-item active">
          ...
          <div class="container">
            ...
            <p>Le damos la más cordial bienvenida al Sistema de Citas Médicas HCJMS creado por estudiantes de la Universidad Mariano Gálvez. Esta plataforma está diseñada para facilitar la gestión de horarios, consultorios y asignación de citas entre pacientes y profesionales de la salud.

Gracias por confiar en nuestra herramienta. Trabajamos para brindarle una experiencia ágil, segura y eficiente.</p>
...
<section id="hero" class="hero">
    <!-- Contenido de la sección Hero aquí -->
        ...
        <div class="row gy-4">
            ...
            <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="100">
                <div class="service-item position-relative">
                    ...
                    <h4>
                        <a href="{{ url('/admin') }}" class="stretched-link">Reserva tu cita médica</a>
                    </h4>
                    <a href="{{ url('/admin') }}" class="btn btn-primary mt-3">Reservar ahora</a>
                </div>
            </div><!-- End Service Item -->

            <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="1000">
    <div class="service-item position-relative">
        <div class="icon"><i class="fas fa-newspaper icon"></i></div>
        <h4><a href="{{ url('/noticias') }}" class="stretched-link">Noticias de Salud</a></h4>
        <p>Lee artículos y consejos sobre salud de nuestros expertos.</p>
    </div>
</div><!-- End Service Item -->
...
<section id="call-to-action" class="call-to-action">
            ...
            <div class="col-md-12">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title"><strong>Calendario de atención de doctores</strong></h3>  
                    </div>
                    <div class="card-body">
    ...
    var url = "{{ route('admin.horarios.cargar_datos_consultorios', ':id') }}".replace(':id', consultorio_id);
      ...
      <div class="row gy-4">
        <div class="col-lg-4 col-md-6 footer-about">
          <a href="{{url('/')}}" class="logo d-flex align-items-center">
            <span class="sitename">SISTEMA MEDICO UMG</span>
          </a>
